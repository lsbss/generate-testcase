...
public class CreateTestCase {
    public static void createTestCase(ArrayList<String> testsList, String wkID) throws IOException, InterruptedException {
        int id_ct = 1;
                ...
                try {
                    ...
                    for(int cont = 0; cont < steps.size(); cont++) {
                        ...
                        if(cont != 0) {
                            ...
                            newStep += "<parameterizedString isformatted=\\\"true\\\">&lt;DIV&gt;&lt;DIV&gt;&lt;P&gt;" + step + "&lt;/P&gt;&lt;/DIV&gt;&lt;/DIV&gt;</parameterizedString>";
                            newStep += "<parameterizedString isformatted=\\\"true\\\">&lt;P&gt;&lt;BR/&gt;&lt;/P&gt;</parameterizedString><description/></step>";
                        }
                    }
                    newStep += "</steps>";
                    // Create a new test case work item
                    String url = "https://dev.azure.com/" + company + "/" + project + "/_apis/wit/workitems/$Test%20Case?api-version=7.1-preview.3";

                    String personalAccessToken = property.getParameter("azure.key");;

                    // Create the request body
                    String requestBody = "[{\"op\": \"add\", \"path\": \"/fields/System.Title\", \"value\": \"" + wkID + id_ct + "\"}, {\"op\": \"add\", \"path\": \"/fields/System.AreaPath\", \"value\": \"" + areaPath + "\" }, {\"op\": \"add\", \"path\": \"/fields/System.IterationPath\", \"value\": \"" + iterationPath + "\"}, {\"op\": \"add\", \"path\": \"/fields/Microsoft.VSTS.TCM.Steps\", \"value\": \"" + newStep + "\"}]"; 
                    id_ct++;
                    // Set up credentials
